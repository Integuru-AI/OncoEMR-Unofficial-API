...
FOLLOWUP_RADIO_BUTTONS_MAPPING = {
    ...
    "ecigarette_use": {
        "options": {
            "Electronic cigarette user": "FD_rdoARRAecigarretteuser"
        }
    },
    "tobacco_type": {
        "options": {
    ...
    "ros_fever": {
        "options": {
            "No fever": "FD_rdoNofever",
            "Fever": "FD_rdoFever"
        }
    },
    "ros_chills": {
        "options": {
            "No Chills": "FD_rdoNoChills",
            "Chills": "FD_rdoChills"
        }
    },
    ...
    "ros_hema_bruising": {
        "options": {
            "No bruising": "FD_rdoNObruising",
            "Bruising": "FD_rdoBruising"
        }
    },
    "ros_hema_bleeding": {
        "options": {
            "No Bleeding": "FD_rdoNoBleeding_1",
    ...
    "pe_head_not_assessed": {
        "options": {
            True: "FD_rdoNotassessed"
        }
    },
    "pe_head_trauma": {
        "options": {
    ...
    "pe_eyes_pupils": {
        "options": {
            "PERRLA": "FD_rdoPEEyes_02",
            "Unequal": "FD_rdoPEEyes_04"
        }
    },
    "pe_eyes_eom": {
        "options": {
            "EOMs intact": "FD_rdoPEEyes_10",
    ...
    "pe_chest_kyphosis": {
        "options": {
            "No kyphosis": "FD_rdoNokyphosis",
            "Kyphosis": "FD_rdoKyphosis"
        }
    },
    "pe_chest_scoliosis": {
        "options": {
